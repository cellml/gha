...
- [SymEngine](https://github.com/symengine/symengine) [0.14.0](https://github.com/symengine/symengine/releases/tag/v0.14.0) (see [license](./LICENSE-SymEngine.txt))
  - [FLINT](http://flintlib.org/) [3.4.0](https://flintlib.org/download/flint-3.4.0.tar.gz) (see [license](./LICENSE-FLINT.txt))
  - [GMP](https://gmplib.org/) [6.3.0](https://gmplib.org/gmp6.3) (see [license](./LICENSE-GMP.txt))
  - [MPFR](https://www.mpfr.org/) [4.2.2](https://www.mpfr.org/mpfr-4.2.2/) (see [license](./LICENSE-MPFR.txt))
